        ...
        <div className="flex flex-wrap items-stretch -mx-4">
          <div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
            <div className="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-gray-900">
              ...
              <p className="mt-3 leadi dark:text-gray-400">
                Read news that you can use & make your everyday more meaningful.
              </p>
              <ul className="flex-1 mb-6 dark:text-gray-400">
                <li className="flex mb-2 space-x-2">
                  ...
                  <span>300+ Exclusive Stories & Expert Opinions</span>
                </li>
                <li className="flex mb-2 space-x-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <li className="flex mb-2 space-x-2">
                  ...
                  <span>6 Weekly Newsletters</span>
                </li>
              </ul>
              <Link to="/subscription">
                <button
                  type="button"
                  className="inline-block px-5 py-3 font-semibold  text-center rounded w-full bg-violet-400 text-gray-900"
                >
                  Get Started
                </button>
              </Link>
          ...
          <div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
            <div className="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-violet-400 dark:text-gray-900">
              <div className="space-y-2">
                <h4 className="text-2xl font-bold">Best Value Plan</h4>
          ...
          <div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
            <div className="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-gray-900">
              <div className="space-y-2">
                <h4 className="text-2xl font-bold">All Access Plan</h4>
                <span className="text-6xl font-bold">
                  $72
                  <span className="text-sm tracki">/month</span>
                </span>
              ...
              <ul className="space-y-2 dark:text-gray-400">
                ...
                <li className="flex items-start space-x-2">
                  ...
                  <span>Everything in Global Times & ePaper</span>
                </li>
                <li className="flex items-start space-x-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <li className="flex items-start space-x-2">
                  ...
                  <span>TimesPrime Membership worth</span>
                </li>
                <li className="flex items-start space-x-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <li className="flex items-start space-x-2">
                  ...
                  <span>All the Others Things</span>
                </li>
              </ul>
              <Link to="/subscription">
                <button
                  rel="noopener noreferrer"
                  className="btn inline-block w-full px-5 py-3 font-semibold tracki text-center rounded bg-violet-400 text-gray-900 hover:bg-slate-400"
                >
                  Get Started
                </button>
              </Link>
